<?php
    ...
    {
    $str="<li><a href='index.php?eis=".$_GET['eis']."&selector=Studiengaenge&course=".$name."' method='get'><img src='views/studiengaenge/data/images/c_icon.png' class='ui-li-icon' ><h6 style=' font-size: 11pt; margin-top: 8px; margin-left: 10px;'>".$name."<h6 class='ui-li-aside' style='display: inline; margin: 0; padding: 0;'>".$bmt_icons."</h6></li>";
    return $str;
    }
