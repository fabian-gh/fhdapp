<?php
/**
*	Dateiname: "backend_deleteConfirmation.php"
*	Zweck:	Diese Datei dient zur Abfrage ob ein Studiengang wirklich gelöscht werden soll.
*	Benutzt von: "backend_studiengaenge.php"
*	Autor Name: Okan Köse
*	Autor E-Mail: okan.koese@gmx.de	
**/
?>
	<!-- Link "Bearbeiten/Löschen"(in der Navigation) aktivieren (rot markieren) -->
	<script type="text/javascript">$('#liEditDeleteStudycourse').attr('class', 'active');</script>
	
	<!-- Daten des zu löschenden Studiengangs holen um z.B. den Namen des Studiengangs zu erfahren -->
