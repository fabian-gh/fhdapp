		...
		<?php
			...
			if(empty($studycourses))
				...
				foreach($studycourses AS $s){	//für jeden tupel, also für jeden Studiengang
					//eine Zeile in der Tabelle ausgeben mit den Spalten "Nr."	"Name"	"Abschlussart"	"Art"	"Bearbeiten"	"Löschen", mit den Werten des Studiengangs
					...
					echo "<input type=\"hidden\" name=\"id\" value=".$s["id"].">";	//Hiddenfield um die id mit zu übergeben
					echo "</form>"; //Formular (für diese eine Tabellenzeile) schließen 
