...
{
$str="<li><a href='index.php?eis=".$_GET['eis']."&selector=Studiengaenge&scourse=".$name."' method='get'><img src='views/studiengaenge/data/images/c_icon.png' class='ui-li-icon' ><h6 style=' font-size: 11pt; margin-top: 8px; margin-left: 10px;'>".$name."<h6 class='ui-li-aside' style='display: inline; margin: 0; padding: 0;'>".$bmt_icons."</h6></li>";
return $str;
}
...
<ul data-role='listview' data-dividertheme='a' data-inset='true' data-mini='true'>
<li data-role='list-divider'>Themen</li>
<li style='background: #fe7373; border-color: #fe7373'><div data-role='controlgroup' data-mini='true'>
...
// -------// View of the second page, where you can select graduate of the course you interested in
class select_graduate_page{
    
function _construct()
{}

function graduate_buttons($course_for_url)
{
$url="index.php?eis=".$_GET['eis']."&selector=Studiengaenge&scourse=".$course_for_url;
return  "<li><a href='".$url."&graduate=Bachelor'>Bachelor</a></li>
<li><a href='".$url."&graduate=Master'>Master</a></li>";
}



function content($course_for_url)
{
// build a page
$html="<div data-role='content'>
<ul data-role='listview' data-inset='true'>".$this->graduate_buttons($course_for_url)."
</ul>
</div>";
return $html;
    }
