...
<?php
	...
	if(isset($_POST["editStudycourseConfirm_btn"])){	///Wenn ein Studiengang erfolgreich bearbeitet wurde
		...
		echo "<h3>Studiengang einfuegen - Best&auml;tigung</h3>";	//Überschrift augeben
		echo "<p style=\"margin: 22px 0px 10px 0px;\">Folgender Studiengang wurde eingef&uuml;gt:<p>";	//Bestätigung ausgeben
	}
?>
	...
	//-- Erster Button --    ->Der Bearbeiten Button (z.B. "Bachelor of Science Medieninformatik bearbeiten")
		...
		echo "<form method=\"post\">";		//Formular für "xy bearbeiten" - ÖFFNEN
				echo "<input class=\"button\" style=\"min-width: 0px; float:right; max-height: 35px; padding: 7px 10px 15px 10px;\" type=\"submit\" value=\"".$studycoursesController->graduateIdToName($_POST["graduate_id"])." ".$_POST["name"]." bearbeiten\" name=\"editStudycourse_btn\">";	//Ausgabe des "xy bearbeiten" - Button
