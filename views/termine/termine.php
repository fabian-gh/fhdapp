<?php
	...
	echo "<div data-role='collapsible-set' data-iconpos='right' data-collapsed-icon='arrow-r' data-expanded-icon='arrow-d' data-theme='a'>";
		for($i = 0; $i < count($semestersWithAppointments); $i++)
		{
			...
			if($i == 0)
				echo "<div data-role='collapsible' data-collapsed='false'><h3>$name</h3><table style='width: 100%; table-layout: fixed; white-space: normal;'>";
			else
				echo "<div data-role='collapsible'><h3>$name</h3><table style='width:100%;'>";
